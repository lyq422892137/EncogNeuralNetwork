...
public class Model {
     ...
     * **/
    public double[][] predictionTestCodeProb(BasicNetwork network, double[][] inputs, double[][] y){
        // create testing data
     ...
     * **/
    public double[][] predictionCodeInteger(double[][] num){
...
//                System.out.println(str1 + " : " + str2);
    ...
    public double[][] predictOne(double[] paras, BasicNetwork network, int col){
        double[] output = new double[col];
        double[][] output2 = new double[Numbers.ONE][col];
        network.compute(paras,output);
        for (int i = Numbers.ZERO; i<col; i++){
            output2[Numbers.ZERO][i] = output[i];
        }
